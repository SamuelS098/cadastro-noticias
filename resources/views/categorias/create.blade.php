...
<head>
    ...
    <title>Nova Categoria | Painel de Administração</title>
    ...
    <style>
        ...
        /* Borda azul com 1px de espessura no foco */
        .form-control:focus {
            border-color: #4a68ff;
        ...
        <div class="col-md-8 col-lg-5 mx-auto">
            <div class="card">
                <div class="text-center mb-4">
                    <i class="bi bi-folder-plus icon-header"></i>
                    <h2 class="titulo mt-3">Cadastrar Nova Categoria</h2>
                    <p class="subtitulo">Adicione uma categoria para organizar o conteúdo do sistema</p>
                </div>
